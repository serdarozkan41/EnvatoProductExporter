...
namespace EnvatoItemGetter
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            columncheck.Items.Insert(5, "EnvatoItemUrl");
            columncheck.Items.Insert(6, "EnvatoItemUpdatedAt");
            columncheck.Items.Insert(7, "EnvatoItemDescription");
            columncheck.Items.Insert(8, "EnvatoItemSite");
            columncheck.Items.Insert(9, "EnvatoItemClassification");
            columncheck.Items.Insert(10, "EnvatoItemClassificationUrl");
            columncheck.Items.Insert(11, "EnvatoItemPriceCents");
            columncheck.Items.Insert(12, "EnvatoItemAuthorImage");
            columncheck.Items.Insert(13, "EnvatoItemSummary");
            columncheck.Items.Insert(14, "EnvatoItemRating");
            columncheck.Items.Insert(15, "EnvatoItemRatingCount");
